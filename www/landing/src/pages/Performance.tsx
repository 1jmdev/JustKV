...
const architectureFeatures = [
    {
        ...
        description:
            "Unlike Redis's single-threaded event loop, BetterKV uses a thread-per-core architecture. Each core handles its own shard of data independently, eliminating contention and lock overhead.",
    },
    {
        title: "Zero-copy Networking",
        description:
            "io_uring-based I/O with zero-copy buffer management. Data moves from the network card to your application without unnecessary memory copies.",
    },
    {
        title: "Lock-free Data Structures",
        description:
            "Core data structures use atomic operations and lock-free algorithms. No mutex contention, no priority inversion, no lock convoys.",
    },
    {
        title: "Optimized Memory Allocator",
        description:
            "Custom slab allocator designed for key-value workloads. Minimizes fragmentation and reduces allocation overhead to near-zero.",
    },
    {
        title: "RESP3 Protocol",
        description:
            "Full support for the RESP3 protocol with optimized parsing. Inline commands are parsed with SIMD acceleration where available.",
    },
    {
        title: "Adaptive Batching",
        description:
            "Automatically batches responses when the client can't keep up, maximizing throughput without sacrificing latency under normal load.",
    },
];
                        ...
                        <table className="w-full min-w-130 text-sm">
                            <thead>
                                <tr className="border-b border-border/50 bg-card">
                                    ...
                                    <th className="px-4 py-3.5 text-right font-medium text-primary sm:px-6">
                                        BetterKV
                                    </th>
