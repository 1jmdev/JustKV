...
const features = [
    ...
    },
    {
        ...
        description:
            "Drop-in replacement. Use your existing Redis clients, no code changes needed.",
    },
    {
        icon: CpuIcon,
        title: "Multi-threaded",
        description:
            "True multi-threaded architecture that scales linearly with CPU cores.",
    },
    {
        icon: MemoryStickIcon,
        title: "Memory Efficient",
        description:
            "Optimized memory allocator designed to minimize fragmentation and overhead.",
    },
    {
...
const useCases = [
    {
        ...
        description: "Application & API response caching",
    },
    {
        icon: UserIcon,
        title: "Sessions",
    ...
    },
    {
        ...
        description: "Real-time counters & leaderboards",
    },
    {
        icon: MailIcon,
        title: "Queues",
        to: "/use-cases/queues",
        description: "Pub/Sub & message queues",
    },
    {
        icon: FlagIcon,
        title: "Feature Flags",
    ...
    },
    {
        ...
        title: "Gaming",
        to: "/use-cases/gaming",
        description: "Leaderboards & game state",
    },
];
                    ...
                    <motion.div {...fadeUp} className="max-w-3xl">
                        ...
                        <h1 className="text-3xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
                            ...
                            <span className="text-primary">
                                Redis should have been.
                            </span>
                        </h1>
                        <p className="mt-4 max-w-xl text-base text-muted-foreground sm:mt-6 sm:text-lg">
                            BetterKV is a Redis-compatible key-value store built
                            in Rust. Multi-threaded, memory-efficient, and 5-15x
                            faster. Drop it in — your code doesn't change.
                        </p>
                ...
                <div className="mx-auto max-w-6xl px-6">
                    <motion.div {...fadeUp}>
                        ...
                        <p className="mt-3 max-w-lg text-muted-foreground">
                            Every layer of BetterKV is optimized for throughput
                            and low latency, from the network layer to the
                            storage engine.
                        </p>
                    </motion.div>
            ...
            <section className="border-b border-border/50 py-24">
                <div className="mx-auto max-w-6xl px-6">
                    <motion.div {...fadeUp}>
                        ...
                        <p className="mt-3 max-w-lg text-muted-foreground">
                            A complete key-value store that's faster, safer, and
                            just as easy to use.
                        </p>
                    </motion.div>
            ...
            <section className="border-b border-border/50 py-24">
                <div className="mx-auto max-w-6xl px-6">
                    <motion.div {...fadeUp}>
                        ...
                        <p className="mt-3 max-w-lg text-muted-foreground">
                            Use any Redis client. No SDK changes. Just point it
                            at BetterKV.
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="p-6 font-mono text-sm leading-relaxed">
                            ...
                            <div className="mt-2 text-muted-foreground">
                                ...
                                <span className="text-foreground">
                                    HSET session:abc token "xyz" expires 3600
                                </span>
                            </div>
            ...
            <section className="border-b border-border/50 py-24">
                <div className="mx-auto max-w-6xl px-6">
                    <motion.div {...fadeUp}>
                        ...
                        <p className="mt-3 max-w-lg text-muted-foreground">
                            From caching to real-time analytics, BetterKV
                            handles it all — faster.
                        </p>
                    </motion.div>
                ...
                <div className="relative mx-auto max-w-6xl px-6 text-center">
                    <motion.div {...fadeUp}>
                        ...
                        <p className="mx-auto mt-3 max-w-md text-muted-foreground">
                            Managed, hosted, and ready to scale. Join the
                            waitlist to get early access and be first to know
                            when we launch.
                        </p>
                        <div className="mt-8">
                            <WaitlistModal>
