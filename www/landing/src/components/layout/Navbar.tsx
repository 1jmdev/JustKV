...
function MobileNavSection({
  ...
  title: string
  links: Array<{ to?: string; href?: string; label: string; icon: React.ElementType; external?: boolean }>
  onClose: () => void
}) {
    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/50 bg-background/80 backdrop-blur-xl">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <WaitlistModal>
            <Button size="sm" className="hidden sm:inline-flex cursor-pointer">Join Waitlist</Button>
          </WaitlistModal>
          ...
          <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
            ...
            <SheetContent side="right" className="w-[280px] overflow-y-auto p-0" showCloseButton={false}>
