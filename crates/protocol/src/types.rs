...
impl BulkData {
    pub fn from_vec(value: Vec<u8>) -> Self {
        let _trace = profiler::scope("crates::protocol::src::types::from_vec");
        Self::Arg(CompactArg::from_vec(value))
    }

    pub fn as_slice(&self) -> &[u8] {
        let _trace = profiler::scope("crates::protocol::src::types::as_slice");
        match self {
    ...
    pub fn into_vec(self) -> Vec<u8> {
        let _trace = profiler::scope("crates::protocol::src::types::into_vec");
        match self {
...
impl RespFrame {
    pub fn ok() -> Self {
        let _trace = profiler::scope("crates::protocol::src::types::ok");
        Self::SimpleStatic("OK")
    }

    pub fn simple_static(value: &'static str) -> Self {
        let _trace = profiler::scope("crates::protocol::src::types::simple_static");
        Self::SimpleStatic(value)
    }

    pub fn error_static(value: &'static str) -> Self {
        let _trace = profiler::scope("crates::protocol::src::types::error_static");
