...
pub(super) fn xadd_into_stream(
    ...
    let _trace = profiler::scope("engine::stream::types::xadd_into_stream");
...
pub(super) fn apply_trim(
    ...
    let _trace = profiler::scope("engine::stream::types::apply_trim");
...
fn current_unix_ms() -> u64 {
    let _trace = profiler::scope("engine::stream::types::current_unix_ms");
...
pub(super) fn ensure_pending_entry(
    ...
    let _trace = profiler::scope("engine::stream::types::ensure_pending_entry");
