...
pub(crate) const TESTS: &[BenchSpec] = &[
    ...
    bench("set_nx", "SETNX", BenchKind::Custom, Some(SETNX)),
    bench("get", "GET", BenchKind::Get, Some(GET)),
    bench("get_set", "GETSET", BenchKind::Custom, Some(GETSET)),
    bench("incr", "INCR", BenchKind::Incr, Some(INCR)),
    bench("incr_by", "INCRBY", BenchKind::Custom, Some(INCRBY)),
    bench("decr", "DECR", BenchKind::Custom, Some(DECR)),
    bench("decr_by", "DECRBY", BenchKind::Custom, Some(DECRBY)),
    ...
    bench("lrange", "LRANGE", BenchKind::Lrange100, Some(LRANGE_100)),
    bench(
        "lrange_300",
        "LRANGE_300",
        BenchKind::Lrange300,
    ...
    bench("zrev_rank", "ZREVRANK", BenchKind::Custom, Some(ZREVRANK)),
    ...
    bench("eval_sha", "EVALSHA", BenchKind::Custom, Some(EVALSHA)),
